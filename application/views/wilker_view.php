    ...
    <div id="top" class="page">
        ...
        <main class="cd-main-content mt-100">
            ...
            <section class="page-section small-section">
                <div class="shadow-title shadow-gray unselectable parallax-1">Wilayah Kerja</div>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="blog-item clearfix">
                                <h2 class="font-face1 section-heading fw800 mt-0 text-center">Wilayah Kerja</h2>
