<div class="page-inner">
    <div class="page-title">
        <h3>Laporan Pengamatan Penyakit Pada Klinik Pengobatan Sekitar Pelabuhan</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="<?php echo site_url('backend/dashboard'); ?>">Dashboard</a></li>
                <li><a href="#">Laporan PKSE</a></li>
                <li class="active">PKSE 6</li>
            </ol>
        </div>
    </div>
    <div id="main-wrapper">
                ...
                <div class="col-md-12">
                    <div class="panel panel-white">
                        <div class="panel-body">
                            <form action="<?php echo site_url('backend/laporan_pkse/cetak_laporan_pkse_6'); ?>" method="post" target="_blank">
                                <div class="row">
                                    <div class="col-md-3">
