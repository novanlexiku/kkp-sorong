<div class="page-inner">
    <div class="page-title">
        <h3>Laporan Keadaan Bahan Operasional (Barang Habis Pakai Selain Obat/Vaksin)</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="<?php echo site_url('backend/dashboard'); ?>">Dashboard</a></li>
                <li><a href="#">Laporan KLW</a></li>
                <li class="active">KLW 8</li>
            </ol>
        </div>
    </div>
    <div id="main-wrapper">
        <div class="row">
                            ...
                            <table id="data-table" class="display table" style="width: 100%; ">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center;" scope="col">Nama Bahan</th>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-white">
                    <div class="panel-body">
                        <form action="<?php echo site_url('backend/laporan_klw/cetak_laporan_klw_8'); ?>" method="post" target="_blank">
                            <div class="row">
                                <div class="col-md-3">
...
<!--ADD RECORD MODAL-->
<form action="<?php echo site_url('backend/laporan_klw/save_klw8'); ?>" method="post">
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Data Keadaan Bahan Operasional (Barang Habis Pakai Selain Obat/Vaksin) Baru</h4>
                </div>
