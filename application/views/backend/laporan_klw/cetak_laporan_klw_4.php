...
<head>
    <title>LAPORAN PENGAMATAN PENGANGKUTAN/PENGIRIMAN ORANG SAKIT Bulan:<?php echo $b['laporan_tanggal_bulan']; ?> Tahun:<?php echo $b['laporan_tanggal_tahun']; ?></title>
    <meta charset="utf-8">
        ...
        <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
            <tr>
                <td colspan="2" style="width:800px;paddin-left:20px;">
                    <center>
                        <h4>LAPORAN PENGAMATAN PENGANGKUTAN/PENGIRIMAN ORANG SAKIT</h4>
                    </center><br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><br /><br /><br /></td>
                <td colspan="11" style="text-align: right;">UKLW-4</td>
            </tr>
        </table>
