...
<head>
    <title>LAPORAN PENERBITAN SURAT KETERANGAN SEHAT UNTUK TERBANG Bulan:<?php echo $b['laporan_tanggal_bulan']; ?> Tahun:<?php echo $b['laporan_tanggal_tahun']; ?></title>
    <meta charset="utf-8">
        ...
        <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
            <tr>
                <td colspan="2" style="width:800px;paddin-left:20px;">
                    <center>
                        <h4>LAPORAN PENERBITAN SURAT KETERANGAN SEHAT UNTUK TERBANG</h4>
                    </center><br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><br /><br /><br /></td>
                <td colspan="11" style="text-align: right;">UKLW-5</td>
            </tr>
        </table>
        ...
        <table border="1" align="center" style="width:1000px;margin-bottom:20px;">
            <thead>
                <tr>
                    ...
                    <th scope="col" colspan="4" class="text-center">Klasifikasi</th>
                ...
                <tr>
                    ...
                    <th style="text-align:center;" scope="col">Bumil</th>
                    <th style="text-align:center;" scope="col">Bayi</th>
                    <th style="text-align:center;" scope="col">Orkit</th>
                    <th style="text-align:center;" scope="col">Lansia</th>
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            ...
                            <?php } ?> </td>
                        <td style="text-align:center;">
                            <?php if ($row->laporan_kelas == 'bayi') {
                                echo '&radic;'; ?>
                            <?php } ?> </td>
                        <td style="text-align:center;">
                            <?php if ($row->laporan_kelas == 'orkit') {
                                echo '&radic;'; ?>
                            <?php } ?> </td>
                        <td style="text-align:center;">
                            <?php if ($row->laporan_kelas == 'lansia') {
                                echo '&radic;'; ?>
                            <?php } ?> </td>
                        <td style="text-align:center;">
