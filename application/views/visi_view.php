    ...
    <div id="top" class="page">
        ...
        <main class="cd-main-content mt-100">
            ...
            <section class="page-section small-section">
                <div class="shadow-title shadow-gray unselectable parallax-1">Visi & Misi</div>
                <div class="container relative">
                    <!-- <div class="row">
                        <div class="col-md-6 col-md-offset-3 mb-10 mb-sm-40 text-center">
                            <h2 class="font-face1 section-heading fw800 mt-0 text-center">Visi & Misi</h2>
                        </div>
                    </div> -->
                    <div class="row">
                        <div class="col-md-4 col-md-offset-1">
                            ...
                            <div class="blog-item clearfix">
                                ...
                                <img src="<?php echo base_url() . 'theme/images/' . $profile_img; ?>">
                        ...
                        <div class="col-md-6">
                            <!-- SECTION BLOG ITEM
								================================================== -->
                            <div class="blog-item clearfix">
                                <h2 class="font-face1 section-heading fw800 mt-0 text-center">Visi</h2>
                                <div class="blog-item clearfix">
                                    <?php echo $profile_visi; ?>
                                </div>
                                <h2 class="font-face1 section-heading fw800 mt-0 text-center">Misi</h2>
                                <div class="blog-item clearfix">
                                    <?php echo $profile_misi; ?>
                                </div>
                                <h2 class="font-face1 section-heading fw800 mt-0 text-center">Nilai-Nilai Organisasi</h2>
                                <div class="blog-item clearfix">
                                    <?php echo $profile_nilai; ?>
                                </div>
