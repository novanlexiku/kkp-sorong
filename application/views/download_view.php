    ...
    <div id="top" class="page">
        ...
        <main class="cd-main-content mt-100">
            ...
            <section class="page-section small-section">
                <div class="shadow-title shadow-gray unselectable parallax-1">Arsip File</div>
                <div class="container relative">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3 mb-10 mb-sm-40 text-center">
                            <h2 class="font-face1 section-heading fw800 mt-0 text-center">Arsip File</h2>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('uploads/files/' . $row['file_name']); ?>" class="btn btn-outline-primary">download</a>
                                                    </td>
                                                </tr>
                                            <?php }
                                        } else { ?>
