...
class Laporan_klw_model extends CI_Model
{
    ...
    function get_all_laporan_klw_8()
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkeluar,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_8 l, tbl_user u, tbl_wilker w WHERE l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id");
        return $hsl;
    }

    function get_all_laporan_klw_9()
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkon1,l.laporan_stokkon2,l.laporan_stokkon3,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_9 l, tbl_user u, tbl_wilker w WHERE l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id");
        return $hsl;
    }
    ...
    function get_all_laporan_klw_8_petugas()
    {
        $wilker = $this->session->userdata('wilker');
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkeluar,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_8 l, tbl_user u, tbl_wilker w WHERE l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id and l.laporan_wilker='$wilker'");
        return $hsl;
    }

    function get_all_laporan_klw_9_petugas()
    {
        $wilker = $this->session->userdata('wilker');
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkon1,l.laporan_stokkon2,l.laporan_stokkon3,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_9 l, tbl_user u, tbl_wilker w WHERE l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id and l.laporan_wilker='$wilker'");
        return $hsl;
    }
    ...
    function add_new_row8($tgl, $nama, $sat, $stok1, $stok2, $stok3, $ket, $wilker)
    {
        $data = array(
            'laporan_tanggal' => $tgl,
            'laporan_nama' => $nama,
        ...
        $this->db->insert('laporan_klw_8', $data);
    }

    function add_new_row9($tgl, $nama, $sat, $stok1, $stok2, $kon1, $kon2, $kon3, $ket, $wilker)
    {
        $data = array(
            'laporan_tanggal' => $tgl,
            'laporan_nama' => $nama,
            ...
            'laporan_stokawal' => $stok1,
            'laporan_stoktambahan' => $stok2,
            'laporan_stokkon1' => $kon1,
            'laporan_stokkon2' => $kon2,
            'laporan_stokkon3' => $kon3,
            'laporan_keterangan' => $ket,
            'laporan_wilker' => $wilker

        );
        $this->db->insert('laporan_klw_9', $data);
    }
    ...
    function get_laporan_klw1()
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,DATE_FORMAT(laporan_tanggal,'%M') AS laporan_tanggal_bulan,DATE_FORMAT(laporan_tanggal,'%Y') AS laporan_tanggal_tahun,l.laporan_id,l.laporan_penyakit_id,p.penyakit_id,p.penyakit_nama,p.penyakit_kategori,l.laporan_abk,l.laporan_tkbm,l.laporan_penumpang,l.laporan_pp,l.laporan_kkp,l.laporan_sh,l.laporan_umum, l.laporan_wilker,u.user_id,u.user_nip,u.user_name, w.wilker_id, w.wilker_nama FROM laporan_klw_1 l, tbl_penyakit p,tbl_user u, tbl_wilker w WHERE l.laporan_penyakit_id = p.penyakit_id and l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id");
        return $hsl;
    }
    ...
    function get_laporan_klw8_all($wilker)
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,DATE_FORMAT(laporan_tanggal,'%M') AS laporan_tanggal_bulan,DATE_FORMAT(laporan_tanggal,'%Y') AS laporan_tanggal_tahun,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkeluar,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_8 l, tbl_user u, tbl_wilker w WHERE l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id and l.laporan_wilker='$wilker'");
        return $hsl;
    }

    function get_laporan_klw8($tgl2, $tgl3, $wilker)
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkeluar,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_8 l, tbl_user u, tbl_wilker w WHERE MONTH(laporan_tanggal)='$tgl2' and YEAR(laporan_tanggal)='$tgl3' and l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id and l.laporan_wilker='$wilker'");
        return $hsl;
    }

    function get_laporan_klw9_all($wilker)
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,DATE_FORMAT(laporan_tanggal,'%M') AS laporan_tanggal_bulan,DATE_FORMAT(laporan_tanggal,'%Y') AS laporan_tanggal_tahun,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkon1,l.laporan_stokkon2,l.laporan_stokkon3,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_9 l, tbl_user u, tbl_wilker w WHERE l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id and l.laporan_wilker='$wilker'");
        return $hsl;
    }

    function get_laporan_klw9($tgl2, $tgl3, $wilker)
    {
        $hsl = $this->db->query("SELECT l.laporan_id,DATE_FORMAT(laporan_tanggal,'%d %M %Y') AS laporan_tanggal,l.laporan_nama,l.laporan_satuan,l.laporan_stokawal,l.laporan_stoktambahan,l.laporan_stokkon1,l.laporan_stokkon2,l.laporan_stokkon3,l.laporan_keterangan,l.laporan_wilker, u.user_id,u.user_name,u.user_nip,u.user_wilker,w.wilker_id,w.wilker_nama FROM laporan_klw_9 l, tbl_user u, tbl_wilker w WHERE MONTH(laporan_tanggal)='$tgl2' and YEAR(laporan_tanggal)='$tgl3' and l.laporan_wilker = u.user_wilker and u.user_wilker = w.wilker_id and l.laporan_wilker='$wilker'");
        return $hsl;
    }
