...
class Sijablay extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('sijablay_umum_view', $data);
	}
	...
	function send()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->sijablay_model->save_message($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $kAp1, $kBp1, $kCp1, $kDp1, $kEp1, $kFp1, $kGp1,  $kHp1, $kIp1, $kIp2);
	...
	function send1()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message1($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k1p1, $k2p1, $k2p2, $k3p1, $k3p2);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-dokumen-kesehatan-kapal');
		}
	}
	...
	function send2()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message2($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k4p1, $k4p2);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-icv-vaksin');
		}
	}
	...
	function send3()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message3($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k5p1);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-poliklinik');
		}
	}
	...
	function send4()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message4($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k6p1);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-ambulance');
		}
	}
	...
	function send5()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message5($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k7p1);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-kesehatan');
		}
	}
	...
	function send6()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message6($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k8p1);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-angkut-jenazah');
		}
	}
	...
	function send7()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message7($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k9p1);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-orang-sakit');
		}
	}
	...
	function send8()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			// $message=strip_tags(htmlspecialchars($this->input->post('message',TRUE),ENT_QUOTES));
			$this->sijablay_model->save_message8($name, $email, $jeniskelamin, $usia, $alamat, $nohp, $identitas, $k10p1);
			$this->session->set_flashdata('msg', '<div class="alert alert-info">Terima kasih telah mengisi kuesioner Sistem Penilaian Berbasis Layanan di Kantor KKP Kelas III Sorong .</div>');
			redirect('sijablay-klirens');
		}
	}
